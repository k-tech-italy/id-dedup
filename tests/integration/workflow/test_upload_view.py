...
class TestUploadView:
    ...
    def test_duplicate_source_image_rejected(self, image_factory):
        # NOTE: this is testing image creation behavior
        image_factory(source_image="images/collision.jpg")
