...
class TestGetKeptImageIds:
    ...
    def test_returns_all_kept_ids_when_all_images_kept(self, logged_in_client):
        ...
        img1 = ticket.images.create(batch=batch, source_image="images/a.jpg")
        img2 = ticket.images.create(batch=batch, source_image="images/b.jpg")
    ...
    def test_excludes_discarded_images(self, logged_in_client):
        batch = Batch.objects.create()
        ticket = ClusterReviewTicket.objects.create(batch=batch, cluster_label=0)
        kept = ticket.images.create(batch=batch, source_image="images/a.jpg")
        ticket.images.create(batch=batch, source_image="images/b.jpg")
